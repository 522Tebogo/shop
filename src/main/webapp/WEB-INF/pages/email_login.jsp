...
<div class="container">
    <div class="login-container">
        ...
        <!-- 邮箱验证码登录表单 -->
        <form action="/user/login/email" method="post" id="emailLoginForm">
            <div class="mb-3">
