    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/good/discount"><i class="bi bi-gift"></i> 限时特惠</a>
                </li>
            </ul>
...
<div class="container">
    <!-- 页面标题 -->
    <h2 class="my-4"><i class="bi bi-gift text-danger"></i> 限时特惠</h2>
    <p class="text-muted mb-4">精选最优惠的特价商品</p>

    <!-- 商品展示 -->
    <div class="row" id="goods-container">
        <c:forEach items="${goods}" var="item">
            <div class="col-md-3 col-6 mb-4">
                <div class="product-card h-100">
                    <span class="discount-badge">特惠</span>
                    <span class="discount-rate">
                        ${100 - Math.round(item.surprisePrice/item.normalPrice*100)}% OFF
                    </span>
    ...
    function loadPage(page) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // 更新商品容器
                const goodsContainer = doc.querySelector('#goods-container');
                if (goodsContainer) {
                    document.querySelector('#goods-container').innerHTML = goodsContainer.innerHTML;
                }
        ...
        pageLinks.forEach(link => {
            link.addEventListener('click', function(e) {
                ...
                const page = parseInt(this.textContent) ||
                    (this.getAttribute('aria-label') === 'Previous' ? ${currentPage - 1} : ${currentPage + 1});
                loadPage(page);
            });
        });
    });
