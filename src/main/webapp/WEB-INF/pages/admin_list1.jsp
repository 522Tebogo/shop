...
<head>
    ...
    <style>
        ...
        .status_y { background-color: #28a745 !important; color: white !important; }
        .status_f { background-color: #ffc107 !important; color: black !important; }
        .status_b { background-color: #dc3545 !important; color: white !important; }
        .status_d { background-color: #6c757d !important; color: white !important; }
        .status_m { background-color: #0d6efd !important; color: white !important; }
    ...
    <script type="text/javascript">
        ...
        // 移除了 upgradeToAdmin 和 demoteToUser JavaScript 函数
    </script>
</head>
<body>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover table-bordered">
                ...
                <tr>
                    ...
                    <th>电话</th>
                    <th>状态</th>
                    <th style="min-width: 220px;">操作</th> <%-- 调整了最小宽度，因为按钮少了 --%>
                </tr>
                </thead>
                <tbody>
                        ...
                        <td class="action-buttons">
                            <c:choose>
                                ...
                                <c:when test="${userItem.status == 'M'}">
                                    <%-- 移除了 "取消管理员" 按钮 --%>
                                    <%-- 如果管理员状态的用户也允许其他操作，可以在这里添加，例如冻结等，但要注意业务逻辑 --%>
                                    <span class="text-muted"><i>管理员账号</i></span>
                                </c:when>
