    ...
    <div class="profile-container">
        ...
        <div class="profile-nav">
            <ul>
                ...
                <li><a href="/user/email" class="active"><i class="bi bi-envelope-fill me-2"></i>绑定邮箱</a></li>
        ...
        <div class="profile-content">
            ...
            <form id="emailForm" class="row justify-content-center">
                <div class="col-md-8">
                    <input type="hidden" id="userId" name="userId" value="${user.id}">

                    <div class="mb-4">
                        <label for="currentEmail" class="form-label">当前邮箱</label>
                        <input type="text" class="form-control" id="currentEmail" value="${user.email}" readonly>
                    </div>

                    <div class="mb-4">
                        <label for="newEmail" class="form-label">新邮箱</label>
                        <input type="email" class="form-control" id="newEmail" name="newEmail" placeholder="请输入邮箱地址" required>
                        <div class="form-text">请确保邮箱地址正确，以便接收验证码</div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#sendCodeBtn').click(function() {
            ...
            // 发送验证码请求
            $.ajax({
                url: '/verification/sendEmailCode',
                type: 'POST',
                data: { email: email },
